    ...
    <div class="integraldetails">
        <div class="integraldetails_items" v-if="loadingStatus && !abnorType">
            <div class="integraldetails_item" v-for="(item,key) in ilarr" :key="key">
                <img class="il_item_img"  src="/static/img/dssy.png" alt="">
                <div class="il_item_cre">
                    <div>{{item.create_time}}</div>
                    <div class="il_item_cre_hui">{{item.title}}</div>
                </div>
                <div class="il_item_int">￥{{item.reward_amount}}</div>
            </div>
        </div>
